...
// Go provides a flag package supporting basic command-line flag
// parsing. We’ll use this package to implement our example
...
// If you provide a flag that wasn’t specified to the flag package, the
// program will print an error message an show the help text again.
