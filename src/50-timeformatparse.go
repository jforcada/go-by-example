...
func main() {
	...
	// Here’s a basic example of formatting a time according to RFC3339, using
	...
	// constant from time for these layouts, but you can also supply custom
	// layouts. Layouts must use the reference time Mon Jan 2 15:04:05 MST 2006
	// to show the pattern with which to format/parse a given time/string.
	// The example time must be exactly as shown: the year 2006, 15 for the
	// hour, Monday for the day of the week, etc.
	p(t.Format("3:04PM"))
