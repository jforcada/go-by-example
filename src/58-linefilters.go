...
// processes it, and then prints some derived result to stdout. grep
// and sed are common line filters.

// Here’s an example line filter in Go that writes a capitalized version
// of all input text. You can use this pattern to write your own Go line
// filters.
package main
