...
func main() {
	...
	// to ensure that they align in table-like output. For basic right-justified
	// width.
	fmt.Printf("|%6s|%6s|\n", "foo", "b")
	...
	// So far we’ve seen Printf, which prints the formatted string to
	// os.Stdout. Sprintf formats and returns a string without printing it
	// anywhere.
