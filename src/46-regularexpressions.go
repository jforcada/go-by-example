...
func main() {
	...
	// Many methods are available on these structs. Here’s a match test like
	// we saw earlier.
	...
	fmt.Println(r.FindAllString("peach punch ping", 2))

	// Our examples above had string arguments and used names like MatchString.
	// We can also provide []byte arguments and drop String from the
	// function name.
	...
	// The regexp package can also be used to replace subsets of strings
	// with other values.
