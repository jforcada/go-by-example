...
// We’ll use these two structs to demonstrate encoding and decoding of
// custom types below.
...
func main() {
	...
	// First we’ll look at encoding basic data types to JSON strings. Here
	// are some examples for atomic values.
	...
	// encoded JSON key names. Check the definition of Response2 above to
	// see an example of such tags.
	res2D := &Response2{
		Page:      1,
		Fruits:    []string{"apple", "peach", "pear"}}
	...
	// them to their appropriate type. For example here we cast the value
	...
	// intermediates between the data and JSON representation on standard
	// out. We can also stream JSON encodings directly to os.Writers like
