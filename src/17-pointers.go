...
// takes an int pointer. The *iptr code in the function body then
// dereferences the pointer from its memory address to the
// current value at that address. Assigning a value to a
